...
class SJISApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.combo_line.addItems(["Adaptive Threshold", "Segmentation (K-means)", "DoG (Soft Lines)", "Canny (Hard Edges)", "Simple (Grayscale)"])
        ...
        self.spin_clean = SliderSpinBox("Clean Str:", 0, 5, 1, 0, False)
        ...
        self.spin_dot_pen = SliderSpinBox("Dot Pen:", 0.0, 20.0, 0.1, 2.0)
